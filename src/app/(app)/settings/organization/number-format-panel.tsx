...
// Number Format (Business Settings → Number Format). Configures document DISPLAY only — digit
// grouping, decimal places, optional rounding of quantities/rates, and an optional custom currency
// symbol. It never changes stored accounting values. The preview updates live while editing.
  ...
  return (
    <div className="flex flex-col gap-5 max-w-xl">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button type="button" variant="glass" onClick={reset} disabled={pending}>
          {t(locale, "Cancel")}
        </Button>
      </div>
    </div>
