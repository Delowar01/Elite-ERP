...
export default async function NewOrderPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <OrderForm locale={locale} customers={customers} products={products} org={org} sealAssets={sealAssets} numberPreview={numberPreview} projects={projects} noteTemplates={presets.noteTemplates} termsGroups={presets.termsGroups}
