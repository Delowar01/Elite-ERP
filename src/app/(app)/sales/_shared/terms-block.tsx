...
import { DocumentTermsEditor } from "./terms-editor";
...
export function TermsBlock({
  ...
  // The document's final Terms & Conditions — one continuous list mixing group + individual terms.
  terms: DocumentTerm[];
  onTermsChange: (t: DocumentTerm[]) => void;
