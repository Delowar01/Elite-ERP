...
export default async function NewQuotationPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <QuotationForm locale={locale} customers={customers} products={products} org={org} sealAssets={sealAssets} numberPreview={numberPreview} projects={projects} noteTemplates={presets.noteTemplates} termsGroups={presets.termsGroups}
